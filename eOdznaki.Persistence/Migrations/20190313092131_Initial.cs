    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumThreads", x => x.AuthorId);
                    table.ForeignKey(
                        name: "FK_ForumThreads_AspNetUsers_AuthorId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumPosts", x => new { x.AuthorId, x.ForumThreadId });
                    table.ForeignKey(
